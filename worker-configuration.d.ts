/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --include-runtime --config /private/tmp/chespanish-types.jsonc` (hash: bc3d8ae7e4ba3e24c7d7626bed49bb82)
