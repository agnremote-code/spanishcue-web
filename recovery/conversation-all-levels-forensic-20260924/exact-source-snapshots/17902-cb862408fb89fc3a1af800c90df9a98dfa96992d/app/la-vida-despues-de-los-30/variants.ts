...
const a2: ConversationLevelVariant<LifeActivities> = {
  ...
  activities: {
    ...
    alt: "Retrato editorial de una adulta organizando citas en un calendario abierto, con luz cálida y detalles verdes.",
  },
...
const b1: ConversationLevelVariant<LifeActivities> = {
  ...
  activities: {
    ...
    phases: session("Presentá una zona con la que te identifiques.", "Elegí dos zonas y abrí una pregunta en cada una.", "Conversad sobre tres áreas distintas; añadid ejemplos y repreguntas.", "Cambiad papeles y explorad otras zonas, relacionando experiencias con planes.", "Compartí una idea que cambió durante la conversación."),
    supports: [],
    speakingHelp: "",
...
const b2: ConversationLevelVariant<LifeActivities> = {
  ...
  activities: {
    ...
    phases: session("Cada persona propone una prioridad y su coste probable.", "Explorad dos zonas con objetivos en tensión e identificad intereses.", "Elegid cuatro tarjetas: defendé una opción, escuchá la objeción y revisá tu postura.", "Simulad una reunión de decisiones para un año compartido; añadí una restricción nueva a mitad del acuerdo.", "Explicá un pacto y el coste que cada parte acepta."),
...
const c2: ConversationLevelVariant<LifeActivities> = {
  ...
  activities: {
    ...
    alt: "Retrato editorial contemplativo con un adulto frente a un reflejo fragmentado y sombras largas, paleta verde y terracota.",
  },
