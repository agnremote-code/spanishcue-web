...
try{
 ...
 await run(['--test','tests/conversation-family-rendering.test.mjs','tests/conversation-families.test.mjs','tests/conversation-variants.test.mjs','tests/conversation-resources.test.mjs','tests/conversation-family-routes.test.mjs','tests/ads-readiness.test.mjs','tests/backend-contract.test.mjs','tests/billing-lifecycle.test.mjs','tests/purchase-claims.test.mjs','tests/build-packaging.test.mjs','tests/marketing-conversion.test.mjs','tests/teacher-access.test.mjs','tests/library-filters.test.mjs','tests/level-cleanup.test.mjs','tests/personal-trainer.test.mjs','tests/rendered-html.test.mjs','tests/verbal-help-contract.test.mjs','tests/verbal-system-contract.test.mjs','tests/spanishcue-brand.test.mjs'],{...process.env,CHESPANISH_TEST_ORIGIN:origin});
