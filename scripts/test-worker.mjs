...
try{
 ...
 await run(['--test','tests/ads-readiness.test.mjs','tests/backend-contract.test.mjs','tests/billing-lifecycle.test.mjs','tests/build-packaging.test.mjs','tests/marketing-conversion.test.mjs','tests/teacher-access.test.mjs','tests/library-filters.test.mjs','tests/rendered-html.test.mjs','tests/verbal-help-contract.test.mjs','tests/verbal-system-contract.test.mjs','tests/spanishcue-brand.test.mjs'],{...process.env,CHESPANISH_TEST_ORIGIN:origin});
