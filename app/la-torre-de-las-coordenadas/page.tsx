...
export const metadata: Metadata = { title:"La Torre de las Coordenadas | CHESPANISH", description:"Clase A1–A2 sobre el tema 8 del PCIC: el adverbio y las locuciones adverbiales." };
