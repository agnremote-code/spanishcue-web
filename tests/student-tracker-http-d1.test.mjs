...
for (const migration of ['drizzle/0000_jazzy_fantastic_four.sql', 'drizzle/0007_tan_selene.sql']) {
...
const identity = (id) => ({
  ...
  'x-chespanish-user-uid': id,
  'x-chespanish-user-email': `${id}@example.test`,
});
